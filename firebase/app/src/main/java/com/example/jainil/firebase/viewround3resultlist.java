...
public class viewround3resultlist extends AppCompatActivity {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot artistSnapshot:dataSnapshot.getChildren())
                {
                    ...
                    if(e.companyid.equals(getIntent().getStringExtra("companyname").toString())&&e.round2result.equals("Pass"))
                        ar.add(e);
                }

                round3resultenterlist adapter=new round3resultenterlist(viewround3resultlist.this,ar);
